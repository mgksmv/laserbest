...
define('C_REST_WEB_HOOK_URL','https://laserbest.bitrix24.ru/rest/33/teln1ftwaa0l10e2/');
...
class CRest
{
    ...
    const int BATCH_COUNT = 50; // count batch 1 query
    const string TYPE_TRANSPORT = 'json'; // json or xml
